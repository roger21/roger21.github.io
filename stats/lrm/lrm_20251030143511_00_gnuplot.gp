...
#set locale "french"
set encoding utf8
set terminal svg size 1920, 1080 dynamic name "lrm_20251030143511_g3_lrem_versus_politiques" font "Verdana,Arial,Sans-serif,Helvetica,14" dashlength 2 linewidth 1 background "#ffffff"
set output "lrm_20251030143511_g3_lrem_versus_politiques.svg"
set title "{/:Bold=18 Le topic LREM versus les topics politiques en nombre de posts en 2024\n{/:Bold=14 (données collectées le jeudi 30 octobre 2025 à 14:35:11)"
...
plot [1104537600:1782864000][0:1400000] \
"lrm_20251030143511_00_data_count_posts_lrem.txt" u 1:2 smooth bezier lw 2 lc rgbcolor "#f2d618" title "posts all time du topic LREM", \
"lrm_20251030143511_00_data_count_posts_republicains.txt" u 1:2 smooth bezier lw 2 lc rgbcolor "#4363d8" title "posts all time du topic LR", \
"lrm_20251030143511_00_data_count_posts_socialiste.txt" u 1:2 smooth bezier lw 2 lc rgbcolor "#f032e6" title "posts all time du topic PS", \
"lrm_20251030143511_00_data_count_posts_lfi.txt" u 1:2 smooth bezier lw 2 lc rgbcolor "#e6194b" title "posts all time du topic LFI", \
"lrm_20251030143511_00_data_count_posts_zemmour.txt" u 1:2 smooth bezier lw 2 lc rgbcolor "#42d4f4" title "posts all time du topic Zemmour", \
"lrm_20251030143511_00_data_count_posts_national.txt" u 1:2 smooth bezier lw 2 lc rgbcolor "#911eb4" title "posts all time du topic RN", \
"lrm_20251030143511_00_data_count_posts_modem.txt" u 1:2 smooth bezier lw 2 lc rgbcolor "#f58231" title "posts all time du topic MoDem", \
"lrm_20251030143511_00_data_count_posts_verts.txt" u 1:2 smooth bezier lw 2 lc rgbcolor "#3cb44b" title "posts all time du topic EELV", \
"lrm_20251030143511_00_data_count_posts_lrem.txt" every ::1310229::1310229 u 1:2:(label_lrem($2)) w labels left tc rgbcolor "#f2d618" point lc rgbcolor "#f2d618" pt 7 ps 1 offset .7,.3 notitle, \
"lrm_20251030143511_00_data_count_posts_republicains.txt" every ::1064624::1064624 u 1:2:(label_republicains($2)) w labels left tc rgbcolor "#4363d8" point lc rgbcolor "#4363d8" pt 7 ps 1 offset .7,.3 notitle, \
"lrm_20251030143511_00_data_count_posts_socialiste.txt" every ::629585::629585 u 1:2:(label_socialiste($2)) w labels left tc rgbcolor "#f032e6" point lc rgbcolor "#f032e6" pt 7 ps 1 offset .7,.3 notitle, \
"lrm_20251030143511_00_data_count_posts_lfi.txt" every ::512393::512393 u 1:2:(label_lfi($2)) w labels left tc rgbcolor "#e6194b" point lc rgbcolor "#e6194b" pt 7 ps 1 offset .7,.3 notitle, \
"lrm_20251030143511_00_data_count_posts_zemmour.txt" every ::303940::303940 u 1:2:(label_zemmour($2)) w labels left tc rgbcolor "#42d4f4" point lc rgbcolor "#42d4f4" pt 7 ps 1 offset .7,.75 notitle, \
"lrm_20251030143511_00_data_count_posts_national.txt" every ::271975::271975 u 1:2:(label_national($2)) w labels left tc rgbcolor "#911eb4" point lc rgbcolor "#911eb4" pt 7 ps 1 offset .7,-.3 notitle, \
"lrm_20251030143511_00_data_count_posts_modem.txt" every ::66424::66424 u 1:2:(label_modem($2)) w labels left tc rgbcolor "#f58231" point lc rgbcolor "#f58231" pt 7 ps 1 offset .7,.75 notitle, \
"lrm_20251030143511_00_data_count_posts_verts.txt" every ::30490::30490 u 1:2:(label_verts($2)) w labels left tc rgbcolor "#3cb44b" point lc rgbcolor "#3cb44b" pt 7 ps 1 offset .7,.15 notitle
