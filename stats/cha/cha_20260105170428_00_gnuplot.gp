...
#set locale "french"
set encoding utf8
set terminal svg size 1920, 1080 dynamic name "cha_20260105170428_g1_counts_all" font "Verdana,Arial,Sans-serif,Helvetica,14" dashlength 2 linewidth 1 background "#ffffff"
...
#set locale "french"
set encoding utf8
set terminal svg size 1920, 1080 dynamic name "cha_20260105170428_g2_evol_all" font "Verdana,Arial,Sans-serif,Helvetica,14" dashlength 2 linewidth 1 background "#ffffff"
...
"cha_20260105170428_00_data_evol.txt" u 1:4 smooth bezier lw 2 lc rgbcolor "#983fcf" title "le nombre de participants présents   "
